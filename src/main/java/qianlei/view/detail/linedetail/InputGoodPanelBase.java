...
import qianlei.view.detail.linedetail.component.ComboPanelBase;
import qianlei.view.detail.linedetail.component.DateChoosePanelBase;
 ...
 * @author qianlei
 */
public class InputGoodPanelBase extends BaseInputPanel {
    ...
    private void setCreateTime(Good good) throws WrongDataException {
        String createTime = get(InputGoodPanelBase.CREATE_TIME);
        Date time;
        try {
    ...
    private void setMaker(Good good) {
        String maker = get(InputGoodPanelBase.MAKER);
        good.setMaker(maker);
    }

    private void setName(Good good) throws WrongDataException {
        String name = get(InputGoodPanelBase.NAME);
        if ("".equals(name.trim())) {
    ...
    private void setId(Good good) throws WrongDataException {
        String id = get(InputGoodPanelBase.ID);
